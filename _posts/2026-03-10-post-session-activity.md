...
You may use gen AI to help your understanding, and for troubleshooting. You **may not** use it to generate data or responses to questions.

## Questions
1. What type of force field have you used in your simulation, and justify your reason? Compare it with other existing force fields!
2. How do you control the temperature and pressure in your simulation? Which algorithms have you used, and justify your reason for choosing them? Compare the algorithms that you've used with one other existing algorithm! 
3. How do you explain the different thermodynamic ensembles affecting your simulation?
